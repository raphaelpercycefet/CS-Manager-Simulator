...
class Match:
    ...
    def test_play_match(self, mapa, economia_time1, economia_time2, tatica_time1, tatica_time2, team1_strong_ct_point, team1_strong_tr_point, team2_strong_ct_point, team2_strong_tr_point):
        ...
        assert modificador_time1_pontoforte == 12
...
team1_strong_tr_point = "A"
team2_strong_ct_point = "Meio"
team2_strong_tr_point = "A"
...
winning_team, loser_rounds = match.test_play_match(mapa, economia_time1, economia_time2, tatica_time1, tatica_time2, team1_strong_ct_point, team1_strong_tr_point, team2_strong_ct_point, team2_strong_tr_point)

print(winning_team.name)
assert winning_team.name == "Vitality"